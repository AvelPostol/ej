...
function adaptive_header(w) {
   ...
   if(w.matches){
      ...
      if(!$('.number').hasClass('done')){
         $('.number').addClass('done').appendTo(headerMenu);
      }
   }
   else{
      $.each($('.header__menu'), function(index, val) {
            if($(this).hasClass('done')){
               $(this).removeClass('done').prependTo($('.header-collumn_right'));
            }
         
      });
      $.each($('.number'), function(index, val) {
         if($(this).hasClass('done')){
            $(this).removeClass('done').prependTo($('.header__phone_number'));
         }
